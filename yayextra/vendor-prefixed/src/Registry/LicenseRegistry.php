...
namespace YayExtraScoped\YayCommerce\AdminShell\Registry;
...
class LicenseRegistry
{
    ...
    public function all(): array
    {
        ...
        $old_plugins = [];
        $handlers = ['YayExtraScoped\YAYDP\License\License_Handler', 'YayExtraScoped\YayMail\License\LicenseHandler', 'YayExtraScoped\Yay_Currency\License\LicenseHandler', 'YayExtraScoped\Yay_Swatches\License\LicenseHandler', 'YayExtraScoped\YayExtra\License\LicenseHandler', 'YayExtraScoped\YayRev\License\LicenseHandler', 'YayExtraScoped\YayWholesaleB2B\License\LicenseHandler', 'YayExtraScoped\YaySMTP\License\LicenseHandler'];
